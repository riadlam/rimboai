...
const CURRENCIES = [
    { code: 'DZD', label: 'د.ج Algerian Dinar (DZD)' },
...
export default function Settings() {
    ...
    const [language, setLanguage] = useState<AppLang>(readLang);
            ...
            <div className="mx-auto max-w-5xl [&_button]:cursor-pointer">
                <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-white/45">Manage your account preferences</p>
                    </div>
                    <button
                        type="button"
                        onClick={saveProfile}
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                    ...
                    <Section title="Profile Settings" className="lg:col-span-2">
                        <div className="grid gap-5 md:grid-cols-[auto_1fr]">
                            <div className="flex flex-col items-center gap-3 md:items-start">
                                ...
                                <label className="flex w-full max-w-[220px] cursor-pointer flex-col items-center rounded-xl border border-dashed border-white/15 bg-white/[0.03] px-3 py-3 text-center transition hover:border-white/25 hover:bg-white/[0.05]">
                                    ...
                                    <span className="text-xs text-white/70">Click or drop to upload</span>
                                    <span className="mt-0.5 text-[11px] text-white/35">or from history</span>
                                </label>
                            </div>
                    ...
                    <Section title="Preferences">
                        ...
                        <p className="mt-3 text-xs text-white/35">Your preferences are saved automatically.</p>
                    </Section>

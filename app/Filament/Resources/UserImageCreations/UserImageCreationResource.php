...
namespace App\Filament\Resources\UserImageCreations;

use App\Filament\Resources\UserImageCreations\Pages\ManageUserImageCreations;
...
class UserImageCreationResource extends Resource
{
    protected static ?string $model = UserImageCreation::class;
    ...
    {
        return [
            'index' => ManageUserImageCreations::route('/'),
        ];
    }
